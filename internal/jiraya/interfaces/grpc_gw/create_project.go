...
func (s *server) CreateProject(ctx context.Context, request *protobuf.CreateProjectRequest) (*protobuf.GetProjectResponse, error) {
	project, err := s.Core().CreateProject(ctx, adapters.ToCreateProjectRequest(request))
